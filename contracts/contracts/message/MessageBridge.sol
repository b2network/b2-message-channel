...
contract B2MessageBridge is IB2MessageBridge, Initializable, UUPSUpgradeable, EIP712Upgradeable, AccessControlUpgradeable {
    ...
    function send(uint256 from_chain_id, uint256 from_id, address from_sender, address contract_address, bytes calldata data, bytes[] calldata signatures) external override {
    ...
    function call(uint256 to_chain_id, address contract_address, bytes calldata data) external override returns (uint256) {
    ...
    function verify(uint256 from_chain_id, uint256 from_id, address from_sender, uint256 to_chain_id, address contract_address, bytes calldata data, bytes calldata signature) public view override returns (bool) {
    ...
    function SendHash(uint256 from_chain_id, uint256 from_id, address from_sender, uint256 to_chain_id, address contract_address, bytes calldata data) public view override returns (bytes32) {
